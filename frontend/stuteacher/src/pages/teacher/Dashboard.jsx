...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const res = await fetch("http://localhost:5000/api/teacher/appointments", {
          headers: {
  ...
  const handleApprove = async (id) => {
    const res = await fetch(`http://localhost:5000/api/teacher/appointments/${id}/approve`, {
      method: "PATCH",
      headers: {
  ...
  const handleReject = async (id) => {
    const res = await fetch(`http://localhost:5000/api/teacher/appointments/${id}/reject`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
